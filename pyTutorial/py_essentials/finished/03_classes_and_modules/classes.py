""" Python is object oriented as well as functional.

    A good knowledge of classes is crucial to working with Python.
"""

class Employee(object):
    """New style classes always inherit from an object or type. If we want
    a base classe with no frills, inherit from object.
